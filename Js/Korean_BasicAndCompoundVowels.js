...
function w3_open() {
  ...
  function addCardToShownCards(card) {
   ...
   //  ----------------------------------------Settings ---------------------------------------
    ...
    // ------------------------------------Audio Playaer ----------------------------------- //
             ...
             const audioButtonVowels = document.getElementById('audioButtonVowels');
             const audioPlayerVowels = document.getElementById('audioPlayerVowels');
            
              // Add a click event listener to the image
              audioButtonVowels.addEventListener('click', function() {
                
                audioPlayerVowels.play();   
             });
  ...
  function changeCardBackground(KatakananewCardBackgroundImageUrl) {
    ...
    const elements = document.querySelectorAll('.VowelsBackgroundeffect');
    ...
    localStorage.setItem('VowelsBackground', KatakananewCardBackgroundImageUrl);
  }
