...
function addCardToShownCards(card) {
 ...
 //  ----------------------------------------Settings ---------------------------------------
  ...
  // ------------------------------------Audio Playaer ----------------------------------- //
           ...
           const audioButtonConsonants = document.getElementById('audioButtonConsonants');
           const audioPlayerVowels = document.getElementById('audioPlayerVowels');
          
            // Add a click event listener to the image
            audioButtonConsonants.addEventListener('click', function() {
              
              audioPlayerConsonants.play();   
           });
...
function changeCardBackground(KatakananewCardBackgroundImageUrl) {
  ...
  const elements = document.querySelectorAll('.ConsonantsBackgroundeffect');
  ...
  localStorage.setItem('ConsonantsBackground', KatakananewCardBackgroundImageUrl);
}
...
function hide_screen_gallery(){
  ...
  const audioPlayer1 = document.getElementById('audioButtonHiragana');
  ...
  const audioPlayerHiragana = document.getElementById('audioPlayerHiragana');
   // Add a click event listener to the image
    ...
    audioButtonHiragana.style.cursor = 'pointer';
